...
`{
	...
	[
		{
			"title": "Pesquisa sobre 'A formação das fronteiras brasileiras'",
			"teacher": "2",
			"date": "Não especificada",
			"content": "Boa noite, alunos!Bem-vindos às atividades remotas, por meio dessa plataforma estarei disponibilizando as atividades que deverão ser entregues após o retorno das aulas, recomendo a vocês a separem uma pastinha com uma folha de caderno com a identificação (nome de vocês, número da chamada, série de vocês, matéria Geografia) e a realização das atividades.Faça uma pesquisa sobre A formação das fronteiras brasileiras, leia o texto da apostila (página 50 e 51), o qual servirá de base para a pesquisa.Boa noite, protejam-se.Professor Luiz - Geografia.",
		...
		},
		{
			...
			"teacher": "5",
			"date": "Não especificada",
			"content": "Pessoal. Segue o vídeo com a explicação do conteúdo",
			"content-image": "image_location",
			"from": "Classroom",
			"url": "https://drive.google.com/file/d/1tGCr1M67oL5OEt6JXOJSX4wd1SZPpskM/view?usp=drivesdk"
		},
		{
			"title": "ORAÇÕES COORDENADAS",
			"teacher": "5",
			"date": "17/05/2020",
			"content": "Após assistir ao video sobre o conteúdo, responda as questões do formulário em anexo.",
			"content-image": "image_location",
			"from": "Classroom",
			"url": "https://docs.google.com/forms/d/e/1FAIpQLScltgrUoZ36bHpLiNrYyeEgL7mBvwObOu20Ka7e8ec4Fj2rYQ/viewform?hr_submission=ChkIpb7VjucBEhAIgovZ0dADEgcIj9bPjucBEAE"
		},
		{
			"title": "ATIVIDADE 1",
			"teacher": "5",
			"date": "10/05/2020",
			"content": "Você deverá utilizar esta atividade para enviar a resolução da Atividade 1, postada no Facebook, no grupo da sala",
			"content-image": "image_location",
			"from": "Classroom",
			"url": "https://www.facebook.com/groups/672625529977682"
		}
